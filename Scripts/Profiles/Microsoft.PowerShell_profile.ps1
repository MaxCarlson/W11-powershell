...
# And that this command is silent and doesnt disrupt the instant prompt
$null = Register-EngineEvent PowerShell.OnIdle -Action { Push-LocationStack }
...
# Set Windows default pager to nvim
$env:PAGER = "nvim -R"  # -R for read-only mode

#echo "alt + space: is *virtually* Windows version of spotlight"
#echo "Windows Terminal: ctrl+shift+p : Like VS Code, all Terminal options" 

### Variables That Have Been Automatically Added via ...
